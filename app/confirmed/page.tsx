...
import { ArrowLeft, Phone, MessageCircle, Star, MapPin, Clock } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="flex items-center justify-between p-4 pt-12">
        ...
        <h1 className="text-lg font-semibold">Driver Assigned</h1>
        <div></div>
      </div>
        ...
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-1 mb-1">
              ...
              <span className="text-sm text-gray-400">(324 rides)</span>
            </div>
            <p className="text-sm text-gray-400">Toyota Camry • ABC 123</p>
          </div>
        </div>
      ...
      <Card className="mx-4 bg-blue-900/50 border-blue-700 p-4 mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-semibold">Arriving in 3 minutes</p>
              <p className="text-sm text-blue-300">Driver is on the way</p>
            </div>
          </div>
      ...
      <div className="mx-4 bg-gray-700 rounded-lg mb-6 h-48 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500">Driver location updates</p>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">123 Main Street, Downtown</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">456 Oak Avenue, Uptown</p>
            </div>
          </div>
        </div>
      </Card>
